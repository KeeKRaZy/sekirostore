...
<body onload="cartLength();">
    ...
    <header>
        <nav>
            <ul>
                ...
                <li><a href="index.php"><h1>SIGN UP</h1></a></li>
                <li>
    ...
    <main>
        <form id="signUpForm" method="POST" onsubmit="return validationCheck()">
            <div> 
                <input type="text" name="name" minlength="2" maxlength="15" required placeholder="First Name">
                <input type="text" name="surname" minlength="2" maxlength="15" required placeholder="Last Name">
            </div>
            <input id="mail" type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}"  minlength="5" maxlength="49" required placeholder="Enter your e-mail">
            <div>
                <input type="password" name="password" id="parole" minlength="8" maxlength="20" required placeholder="Enter your password">
                <input type="password" name="confirm" id="confirm" minlength="8" maxlength="20" required placeholder="Enter your password">
            </div>
                <span id="showme"> <input type="checkbox" onclick="ShowAllPasswords();"> Show Password </span>
                <?php echo "<p id='errorMessage'>$error</p>";?>  
            <input type="submit" name="button" id="subbmitForm" value="SIGN UP">
            <p>If you already have an account, you can <a href="login.php">Sign In</a></p>
        </form>
    </main>
</body>
