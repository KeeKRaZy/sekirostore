...
if (isset($_POST['button'])) {
    ...
    $query = mysqli_query($start, "SELECT * FROM `users` WHERE `email`='{$email}' AND `password`='{$password}';");
...
<body onload="cartLength();">
    ...
    <header>
        <nav>
            <ul>
                ...
                <li><a href="index.php"><h1>SIGN IN</h1></a></li>
                <li>
    ...
    <main>
        <form method="POST">
            <input type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}"  minlength="5" maxlength="49" required placeholder="Enter your e-mail" />
            ...
            <input type="submit" name="button" id="subbmitForm" value="LOG IN">
